...
public partial class MainWindow
{
    ...
    void UpdateMfdBody()
    {
        ...
        MfdBody.Text = page switch
        {
            ...
            "Correspondence" => "Correspondence host (Glass WPF).\n\nCRS live host SSOT = CIDE Avalonia Correspondence MFD (ADR 0155/0156) + cdp_analysis_scene feature=correspondence.\nCabinGlass pin correspondence/crs → this MFD; no SoftOrganKind — SoftOrganMfdGlance unbound (do not invent SoftOrgan; SoftOrganKind.Crm chrome ≠ CRS).\n\n(Glass CRS peel later.)",
