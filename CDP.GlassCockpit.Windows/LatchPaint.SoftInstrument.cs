...
/// <summary>SoftInstrument latch chrome_hint / pulse read for Glass band.</summary>
internal static partial class LatchPaint
{
    /// <summary>Read SoftInstrument latch chrome_hint (null if idle / missing / parse fail).</summary>
