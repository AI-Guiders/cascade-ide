...
public sealed class WebAiPortalCommandBridgeTests
{
    [Fact]
    public async Task Execute_rejects_when_bridge_not_armed()
    {
        var fake = new FakeActions();
        var bridge = new WebAiPortalCommandBridge(fake);
        bridge.BridgeConsented = true;
        bridge.BridgeArmed = false;
        var r = await bridge.ExecuteFromWebJsonAsync(
            """{"command_id":"codebase_index_search","args":{"query":"x"}}""",
            TestContext.Current.CancellationToken);
        Assert.Contains("not armed", r, StringComparison.OrdinalIgnoreCase);
    }

    [Fact]
    public async Task Execute_rejects_unknown_command_id()
    {
        var fake = new FakeActions();
        var bridge = new WebAiPortalCommandBridge(fake)
        {
            BridgeConsented = true,
            BridgeArmed = true,
        };
        var r = await bridge.ExecuteFromWebJsonAsync(
            """{"command_id":"open_file"}""",
            TestContext.Current.CancellationToken);
        Assert.Contains("not allowed", r, StringComparison.OrdinalIgnoreCase);
    }

    [Fact]
    public async Task Execute_forwards_whitelisted_command()
    {
        var fake = new FakeActions();
        var bridge = new WebAiPortalCommandBridge(fake)
        {
        ...
        var r = await bridge.ExecuteFromWebJsonAsync(
            """{"command_id":"codebase_index_search","args":{"query":"test"}}""",
            TestContext.Current.CancellationToken);
        Assert.Equal("{\"hits\":[]}", r);
        Assert.Equal(IdeCommands.CodebaseIndexSearch, fake.LastCommandId);
    }
    ...
    private sealed class FakeActions : IIdeMcpActions
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (commandId == IdeCommands.CodebaseIndexSearch)
                return Task.FromResult("{\"hits\":[]}");
            return Task.FromResult("OK");
        }

        public Task<string> RequestConfirmationAsync(string message, CancellationToken cancellationToken = default) =>
            Task.FromResult(ConfirmationResponses.Ok);
        ...
        public Task<string> SearchWebPublicQueryAsync(string query, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> FetchWebPublicUrlAsync(string url, int? maxChars, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        ...
        public Task<string> ReadKnowledgeFileAsync(string filePath, int? offset = null, int? limit = null, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> ListKnowledgeFilesAsync(string? subdir = null, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> WriteKnowledgeFileAsync(string filePath, string content, string? knowledgePath = null, bool saveRevision = true, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> AppendKnowledgeFileAsync(string filePath, string content, string? knowledgePath = null, bool saveRevision = true, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> UpsertKnowledgeSectionAsync(string filePath, string sectionId, string content, string? knowledgePath = null, bool saveRevision = true, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> DeleteKnowledgeFileAsync(string filePath, string? knowledgePath = null, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        public Task<string> DeleteKnowledgeSectionAsync(string filePath, string sectionId, string? knowledgePath = null, string? knowledgeRootId = null, CancellationToken cancellationToken = default) => throw new NotImplementedException();
