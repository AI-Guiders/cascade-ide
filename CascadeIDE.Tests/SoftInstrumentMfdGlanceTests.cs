...
public class SoftInstrumentMfdGlanceTests
{
    [Theory]
    ...
    {
        Assert.Equal(organ, SoftInstrumentMfdGlance.TryOrganIdForMfdPage(page));
    }
    ...
    public void TryFormatFromJson_test_desk_includes_counts_and_verdict()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("test_desk", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_debug_desk_includes_bp_and_flags()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("debug_desk", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_toolchain_includes_pulse_and_counts()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("toolchain", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_sys_notes_conpty_later()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("sys", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_review_includes_file_counts()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("review", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_arch_includes_profile_mode()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("arch", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_mcp_includes_mounted()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("mcp", json);
        Assert.NotNull(body);
    ...
    public void TryFormatFromJson_report_notes_md_host()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("report", json);
        Assert.NotNull(body);
        Assert.Contains("report latch glance · idle", body);
        Assert.Contains("Markdig", body);
        Assert.Contains("■ Glass Markdig FlowDocument", body);
    ...
    public void TryFormatFromJson_refactor_includes_hotspots()
    {
        ...
        var body = SoftInstrumentMfdGlance.TryFormatFromJson("refactor", json);
        Assert.NotNull(body);
