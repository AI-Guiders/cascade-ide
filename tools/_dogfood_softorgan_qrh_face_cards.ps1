...
public static class SoftOrganWin {
...
[void][SoftOrganWin]::ShowWindow($h, 9)
[void][SoftOrganWin]::SetForegroundWindow($h)
...
$out = Join-Path $PSScriptRoot '..\tmp-glass-shots\softorgan-qrh-face-cards-20260808.png'
