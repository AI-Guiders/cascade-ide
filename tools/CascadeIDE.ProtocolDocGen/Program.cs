...
internal static class IdeMcpCommandExecutorEmitter
{
    ...
    public static string Emit()
    {
        ...
        sb.AppendLine("        add(Services.IdeCommands.GetIdeState, async (_, _) => await ((IIdeMcpActions)_vm).GetIdeStateAsync());");
        ...
        sb.AppendLine("        add(Services.IdeCommands.SearchWebPublicQuery, async (args, ct) => await ((IIdeMcpActions)_vm).SearchWebPublicQueryAsync(McpCommandJsonArgs.String(args, \"query\") ?? \"\", ct));");
        sb.AppendLine("        add(Services.IdeCommands.FetchWebPublicUrl, async (args, ct) => await ((IIdeMcpActions)_vm).FetchWebPublicUrlAsync(McpCommandJsonArgs.String(args, \"url\") ?? \"\", McpCommandJsonArgs.OptionalInt32(args, \"max_chars\"), ct));");
        sb.AppendLine("        add(Services.IdeCommands.GetCodeNavigationContext, async (args, _) => await ((IIdeMcpActions)_vm).GetCodeNavigationContextAsync(McpCommandJsonArgs.String(args, \"mode\") ?? \"related\", McpCommandJsonArgs.String(args, \"file_path\"), McpCommandJsonArgs.OptionalInt32(args, \"line\"), McpCommandJsonArgs.OptionalInt32(args, \"column\"), McpCommandJsonArgs.OptionalInt32(args, \"max_related\"), McpCommandJsonArgs.OptionalInt32(args, \"max_nodes\"), McpCommandJsonArgs.OptionalInt32(args, \"max_edges\"), McpCommandJsonArgs.String(args, \"preset\"), McpCommandJsonArgs.StringList(args, \"include_kinds\"), McpCommandJsonArgs.StringList(args, \"exclude_kinds\"), McpCommandJsonArgs.String(args, \"level\")));");
