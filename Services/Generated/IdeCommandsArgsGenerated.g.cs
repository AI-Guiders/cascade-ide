...
internal static class IdeCommandsArgsGenerated
{
    private static readonly Dictionary<string, IdeCommandsArgs.Arg[]> ArgsByCommandId = new(StringComparer.Ordinal)
    {
        ...
        ["intercom.reveal_attachment"] = new IdeCommandsArgs.Arg[] { new("anchor_json", "object", false, false, null), new("file", "string", false, false, null), new("line_start", "integer", false, false, null), new("line_end", "integer", false, false, null), new("member_key", "string", false, false, null), new("select", "boolean", false, false, null) },
        ...
        ["reveal_editor_range"] = new IdeCommandsArgs.Arg[] { new("file_path", "string", true, false, null), new("start_line", "integer", true, false, null), new("end_line", "integer", true, false, null) },
