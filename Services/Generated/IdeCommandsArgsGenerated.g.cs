...
internal static class IdeCommandsArgsGenerated
{
    private static readonly Dictionary<string, IdeCommandsArgs.Arg[]> ArgsByCommandId = new(StringComparer.Ordinal)
    {
        ...
        ["get_workspace_navigation_context"] = new IdeCommandsArgs.Arg[] { new("mode", "string", true, false, null), new("file_path", "string", false, false, null), new("line", "integer", false, false, null), new("column", "integer", false, false, null), new("max_related", "integer", false, false, null), new("max_nodes", "integer", false, false, null), new("max_edges", "integer", false, false, null), new("preset", "string", false, false, null), new("include_kinds", "string", false, true, "string"), new("exclude_kinds", "string", false, true, "string"), new("level", "string", false, false, null) },
