...
internal static class IdeCommandsArgsGenerated
{
    private static readonly Dictionary<string, IdeCommandsArgs.Arg[]> ArgsByCommandId = new(StringComparer.Ordinal)
    {
        ...
        ["forge_lens.open"] = new IdeCommandsArgs.Arg[] { new("bracket", "string", true, false, null), new("base_url", "string", false, false, null), new("select_code", "boolean", false, false, null) },
