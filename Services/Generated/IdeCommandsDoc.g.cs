...
internal static class IdeCommandsDoc
{
    private static readonly Dictionary<string, string> SummaryByCommandId = new(StringComparer.Ordinal)
    {
        ...
        ["ide_agent_status"] = "AEE status snapshot: active, run_id, verify_snapshot_id, policy, sandbox_profile, sandbox_run_directory, execution_channel (BuildTestJobCoordinator), writes_invalidated_verify_epoch. returns: json.",
