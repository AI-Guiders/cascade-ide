...
public static partial class IdeCommands
{
    ...
    /// <summary>Развернуть/свернуть регион Pfd в main grid (Semantic Map в зоне Pfd). args: visible:boolean; returns: text; example: {"visible":true}.</summary>
    ...
    /// <summary>Развернуть регион Pfd / Semantic Map (toolbar). returns: text.</summary>
