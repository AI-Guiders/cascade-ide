...
public static partial class IdeCommandRegistry
{
    private static void RegisterDebugPalette(ImmutableArray<IdeCommandRegistryEntry>.Builder b)
    {
        ...
        AddPalette(b, "debug_step_over", IdeCommands.DebugStepOver, "Отладка: шаг с обходом", "Отладка", null, ImmutableArray.Create(UiModeFamily.Debug));
        AddPalette(b, "debug_step_into", IdeCommands.DebugStepInto, "Отладка: шаг с заходом", "Отладка", null, ImmutableArray.Create(UiModeFamily.Debug));
        AddPalette(b, "debug_step_out", IdeCommands.DebugStepOut, "Отладка: шаг с выходом", "Отладка", null, ImmutableArray.Create(UiModeFamily.Debug));
        AddPalette(b, "debug_stop", IdeCommands.DebugStop, "Отладка: остановить", "Отладка", null, ImmutableArray.Create(UiModeFamily.Debug));
