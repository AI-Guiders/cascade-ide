...
public static partial class IdeCommands
{
    ...
    /// <summary>Прикрепить выделение редактора к черновику Intercom (ADR 0128 H0). returns: text.</summary>
    public const string IntercomAttachSelection = "intercom.attach_selection";

    /// <summary>Прикрепить syntax scope @ caret к черновику (ADR 0128 H0b). returns: text.</summary>
    public const string IntercomAttachScope = "intercom.attach_scope";

    /// <summary>Прикрепить диагностику @ caret к черновику. returns: text.</summary>
    public const string IntercomAttachDiagnostic = "intercom.attach_diagnostic";
