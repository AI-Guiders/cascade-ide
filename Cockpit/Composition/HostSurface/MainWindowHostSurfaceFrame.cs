...
/// <param name="Instruments">Привязки слот → инструмент; задаётся <see cref="ISurfaceSlotInstrumentBindingProvider"/> (v1 — SE в Pfd при видимой колонке; далее SM/Mfd — см. дефолтную реализацию).</param>
