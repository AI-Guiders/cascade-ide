...
/// <param name="Instruments">Привязки слот → инструмент; задаётся <see cref="ISurfaceSlotInstrumentBindingProvider"/> (Semantic Map в Pfd, дерево решения в Mfd при видимых колонках — см. дефолтную реализацию).</param>
