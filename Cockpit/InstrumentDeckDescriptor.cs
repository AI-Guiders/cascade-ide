...
/// <param name="SemanticAnchorId">Якорь внимания: например константы <c>pfd</c>/<c>mfd</c> из <see cref="Composition.HostSurface.CockpitSlotIds"/> или идентификатор канала (см. <see cref="Composition.WorkspaceHealth.IdeHealthInstrumentDeck.SemanticAnchorId"/>).</param>
