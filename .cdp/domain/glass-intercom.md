...
- **PreCondition (operator 2026-08-05):** CIDE EOL → Glass Done requires `All CIDE surfaces adopted` (or named supersede). **Not only Intercom Overview** — full gap table A1–A5 / B1–B3 in cdp-mcp `.cdp/domain/glass.md` PreCondition §. Topics P0b strip ≠ ADR 0072 overview (A1).
