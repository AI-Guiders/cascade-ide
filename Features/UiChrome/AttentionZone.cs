...
/// три пространственных якоря (<see cref="Forward"/>, <see cref="Pfd"/>, <see cref="Mfd"/>),
...

{
    ...
    public const string Forward = AttentionZoneCanonicalIds.Forward;

    public const string Pfd = AttentionZoneCanonicalIds.Pfd;

    public const string Mfd = AttentionZoneCanonicalIds.Mfd;

    public const string Eicas = AttentionZoneCanonicalIds.Eicas;

    public const string Hud = AttentionZoneCanonicalIds.Hud;
    ...
    public static ImmutableArray<string> All { get; } =
        ...
        ImmutableArray.Create(Forward, Pfd, Mfd, Eicas, Hud);
...

{
    ...
    /// <summary>Лобовое (forward): редактор.</summary>
...

{
    ...
    public static string ToCanonicalId(this AttentionZone zone) =>
...

        {
            ...
            AttentionZone.Forward => AttentionZoneIds.Forward,
...

    {
        ...
        if (value == AttentionZoneIds.Forward)

        {

            zone = AttentionZone.Forward;
    ...
    public static bool IsSpatialAnchor(this AttentionZone zone) =>
        ...
        zone is AttentionZone.Forward or AttentionZone.Pfd or AttentionZone.Mfd;
