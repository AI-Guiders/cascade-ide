...
- **`Application/`** — `IEditorSurfaceAdapter`, `AvaloniaEditSurfaceAdapter`, `EditorStabilizedInputThrottler` (hi-freq bounded, не `IDataBus`), заготовки `EditorHudEngine` / `SemanticProjectionPipeline`.
