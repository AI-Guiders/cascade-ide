...
[IoBoundary]
internal sealed class RedirectedIntegratedShellSession(ShellLaunchConfiguration launch) : IIntegratedShellSession
{
    ...
    public void Start()
    {
        ...
        IntegratedShellLaunch.ApplyUtf8ConsoleEnvironment(startInfo.Environment);
