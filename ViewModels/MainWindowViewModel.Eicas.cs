...
{
    /// <summary>Упорядоченные оповещения для <see cref="Views.EicasStripView"/>; источник — <see cref="EicasCompositor"/>.</summary>
    ...
    private void RebuildEicas()
    {
        ...
        OnPropertyChanged(nameof(ShowEicasStrip));
        OnPropertyChanged(nameof(ShowWorkspaceTelemetrySurfaceHost));
