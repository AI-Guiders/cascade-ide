...
public partial class MainWindowViewModel
{
    ...
    private Action<string?, int, int, int?>? _revealEditorRangeAction;
    ...
    public void SetRevealEditorRange(Action<string?, int, int, int?> action) => _revealEditorRangeAction = action;
