...
internal sealed partial class IdeMcpCommandExecutor
{
    partial void RegisterGenerated(Action<string, Handler> add)
    {
        ...
        add(Services.IdeCommands.SearchWebPublicQuery, async (args, ct) => await ((IIdeMcpActions)_vm).SearchWebPublicQueryAsync(McpCommandJsonArgs.String(args, "query") ?? "", ct));
        add(Services.IdeCommands.FetchWebPublicUrl, async (args, ct) => await ((IIdeMcpActions)_vm).FetchWebPublicUrlAsync(McpCommandJsonArgs.String(args, "url") ?? "", McpCommandJsonArgs.OptionalInt32(args, "max_chars"), ct));
