...
| ID | Title | Status (raw) |
|----|-------|----------------|
| [0018](../../adr/0018-ide-commands-canonical-xml-documentation.md) | Каноничные XML-доки для `IdeCommands` и ProtocolDocGen | Proposed (направление; срок и объём миграции — по приоритетам) |
...
| [0060](../../adr/0060-keyboard-chord-stack-fms-tactical-strategic.md) | Аккордный слой (FMS-style), S/T и overlay — расширение keyboard-first (ADR 0013) | Proposed |
