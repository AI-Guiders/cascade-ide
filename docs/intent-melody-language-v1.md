...
**Оси с высоким трафиком** (ориентир, не жёсткий закон): **Git**, **сборка**, **отладка**, **тесты**, **запуск** — первыми получают короткие мнемоники в реестре.
