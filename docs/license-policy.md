...
Исходный код продукта в этом репозитории — **[MIT](../LICENSE)** (MIT (see ethical-use policy)). Коммерческое предложение и публичные контакты — **[COMMERCIAL-NOTICE.md](COMMERCIAL-NOTICE.md)**. Явная политика для читателя README — корневой [`README.md`](../README.md) (раздел «Этическая политика»).
