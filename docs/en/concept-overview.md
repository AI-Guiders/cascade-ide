...
CIDE is an open **working implementation** of **[IOP](iop-manifest-v1.md)** — a **discipline of communication** (aligned goals, transparency, explicit *intent*), agent synthesis, and **diff verification** in the editor. See [ADR 0121](adr/0121-intent-oriented-programming-paradigm.md) (Accepted) for the full framing.
