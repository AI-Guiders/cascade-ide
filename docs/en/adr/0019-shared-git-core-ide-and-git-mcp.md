...
- **Source location:** submodule [`git-mcp-core/`](../../../git-mcp-core/) in the root of meta-repo `open` (next to `git-mcp`). **Canonical remote:** [AI-Guiders/git-mcp-core](https://github.com/AI-Guiders/git-mcp-core); mirror for **Trusted Publishing** NuGet - **[KarataevDmitry/git-mcp-core](https://github.com/KarataevDmitry/git-mcp-core)**. **Consumers** include the **`AIGuiders.GitMcp.Core`** package from nuget.org (`PackageReference`).
