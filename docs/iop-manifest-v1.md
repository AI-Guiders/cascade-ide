...
**Интенционально-ориентированное программирование** — парадигма, в которой ты задаёшь **намерение** и **целевое состояние**, а не вручную «компилируешь» каждую строку синтаксиса. **Cascade IDE** — открытая *reference implementation* этой модели для .NET и agent-first работы.
