...
**Environment-first и голос:** в одной комнате люди чаще **говорят**, чем пишут в чат — агентам нельзя честно обещать «услышали всё». IOP не ставит на **полную транскрипцию** стола (зёрна/плевел); на стене и в Intercom фиксируется **результат договорённости** (карточка, pin, краткая структурированная заметка), а не каждая реплика у доски.
