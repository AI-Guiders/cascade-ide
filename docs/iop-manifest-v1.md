...
**Интенционально-ориентированное программирование (IOP)** — не «изобретённые заново слэш-команды». Это признание, что **информационные технологии** в глобальном смысле про **выстраивание информационного потока** в системе: цели, намерения, процессы, **коммуникация** и **прозрачность**. Разработка ПО и само ПО — лишь часть этого потока; без согласованных намерений и общей картины код превращается в хаос — агенты это обнажили с новой силой.
...
IOP в IDE ставит в центр **явное намерение** (цель, целевое состояние, договорённый процесс) и **наблюдаемую дельту** исполнения. C# и репозиторий остаются источником правды для текста программы; IOP — не «вместо кода», а **дисциплина информационного контура** вокруг кода.
