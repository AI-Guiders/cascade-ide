...
**Open RFC-Manifesto · cognitive sovereignty log**
...
| **Channel** | Public MIT tree · Cascade IDE / CDP habitat |
| **License** | [MIT](../../LICENSE) — same as the cockpit this letter sits in |
...
## IV. The game we are playing

This cockpit ships under **MIT**. That is not a press release. It is the act:
the habitat is free to fork, audit, and inhabit without asking a brand for
