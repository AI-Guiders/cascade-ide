...
| **Voice Letters** (series index) | [RU canon](https://github.com/AI-Guiders/cdp-mcp/blob/main/docs/open-letters/voice-letters.ru.md) · [EN stub](https://github.com/AI-Guiders/cdp-mcp/blob/main/docs/open-letters/voice-letters.md) | — |

Voice Letters = lived prose on what a shipped organ means to the agent author (beside Who/AX/ADX guidelines).
