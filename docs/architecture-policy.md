...
| **Intercomm:** пользовательское имя канала связи в IDE (не только LLM); модель «участники + система»; алиасы discoverability; код `chat*` — strangler ([0080](adr/0080-intercomm-naming-and-multi-party-channel-model.md)) | [0080](adr/0080-intercomm-naming-and-multi-party-channel-model.md) (Proposed) |
