...
- **v1.39** — [0017](adr/0017-multi-window-workspace-and-agent-surfaces.md) [п. 8](adr/0017-multi-window-workspace-and-agent-surfaces.md#adr0017-p8-mfd-host-wide): **`MfdHostWindow`** — только **полный** `MfdShellView` (все `SecondaryShellPage`); узкий одностраничный хост **не** планируется.  
