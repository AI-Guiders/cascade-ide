...
- **Постоянная транскрипция** разговора в комнате как единственный источник правды для агентов — против IOP (зёрна/плевел, приватность, шум).
