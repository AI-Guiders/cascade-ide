...
**Назначение:** один **входной** ADR для читателя: **как мы думаем про интерфейс и опыт**, без обхода десятков записей. Детали, таблицы терминов и исключения — в исходных ADR и в [cascadeide-philosophy-v1.md](../design/cascadeide-philosophy-v1.md).
