...
- **Свёртка сырья в снимок/DTO канала** (агрегация, приоритеты, теги уровня A/B/C) — это **не** ответственность шины; см. [0097](0097-cockpit-compute-nodes-transport-to-channel-dto.md).
...
**Не начато** на момент принятия формулировки: ADR задаёт направление; первая реализация — по отдельным коммитам и с тестом на батчинг/дроп при переполнении (если выбран bounded-режим).
