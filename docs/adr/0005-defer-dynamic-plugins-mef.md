...
**Обновлено:** 2026-04-06 — примечание: плагины неизбежны в зрелой IDE, но ближайший фокус — кокпит и зоны ([0021](0021-pfd-mfd-cockpit-attention-model.md)); откладывание не отрицает ценность расширяемости.
