...
**Обновлено:** 2026-04-06 — плагины отложены; фокус на кокпите ([0021](0021-pfd-mfd-cockpit-attention-model.md)). Подробности — [§ История](#adr0005-history).

## Связанные ADR

| ADR | Роль |
|-----|------|
| [0021](0021-pfd-mfd-cockpit-attention-model.md) | сначала модель внимания и слоты, потом plugin host |
| [0024](0024-ide-sdk-and-stable-contracts.md) | будущие стабильные контракты расширений |
