...
| Окно-хост MFD | `Views/MfdHostWindow.axaml` — полный `SecondaryShellView` ([п. 8](#adr0017-p8-mfd-host-wide)), тот же `DataContext`, что у `MainWindow`; слой подсветки MCP как у главного окна. |
