...
| ADR | Роль |
|-----|------|
| [0028](0028-user-settings-toml-localappdata-and-secrets.md) | путь и секреты |
| [0038](0038-agent-facade-ai-provider-and-tool-orchestration.md) | фасад провайдеров и инструментов |
