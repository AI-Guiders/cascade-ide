...
**Дата:** 2026-04-17  
**Обновлено:** 2026-04-17 — зафиксировано **намеренное разделение** с Semantic Map / WSNC (см. [Почему не WSNC](#adr0062-not-wsnc)). Подробности — [§ История](#adr0062-history).
...
| Дата | Изменение |
|------|-----------|
| 2026-04-17 | зафиксировано **намеренное разделение** с Semantic Map / WSNC (см. [Почему не WSNC](#adr0062-not-wsnc)). |
