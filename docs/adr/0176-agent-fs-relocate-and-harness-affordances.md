...
### Рамка (канон, не дубль)

Философия среды уже в [0166](0166-agent-centric-harness-model-comfort-and-pay-per-token-economics.md) §2 («ничего о нас без нас»; модель — со-stakeholder) и L0 `agent-equal-standing-v1`. Здесь только **инстанс**: tool loop без агента-участника → Write+Delete вместо relocate; чинить аффордансом (`fs_relocate`), не промптом.
