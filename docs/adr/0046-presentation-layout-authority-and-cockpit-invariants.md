...
- На сборке: Roslyn **CASCOPE003** (`CascadeIDE.ArchitectureAnalyzers`) — прямые присваивания `IsSolutionExplorerVisible` / `IsChatPanelExpanded` (и бэкинг-полей) вне [белого списка файлов](../../CascadeIDE.ArchitectureAnalyzers/README.md); новые точки — через `Apply*` / расширение списка в анализаторе.
