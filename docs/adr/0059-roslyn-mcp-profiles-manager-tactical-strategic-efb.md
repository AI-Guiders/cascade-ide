...
|------|------|-----------------|-------------------|
| **Центр (Forward / PFD)** | **Тактический** | Динамический профиль, узкий MCP, граф под курсор / `controlFlow` ([0053](0053-semantic-map-control-flow-pfd.md)). | Высокая (с учётом Echelon / debounce). |
