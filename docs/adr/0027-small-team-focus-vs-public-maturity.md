...
**Статус:** Accepted  
**Дата:** 2026-04-08  
**Обновлено:** 2026-04-08 — Accepted; уточнён минимум discoverability (дока + примеры + ADR, ссылка на чертёж онбординга); добавлены **триггеры** вы… Подробности — [§ История](#adr0027-history).  
## Связанные ADR
