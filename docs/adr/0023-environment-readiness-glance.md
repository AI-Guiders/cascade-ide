...
6. **Слой представления** (вкладка MFD, бейджи PFD, команда палитры) задаётся пресетом и ADR 0021 отдельно от полосы Workspace Health.
...
- Локализация заголовков вкладки/карточки.
