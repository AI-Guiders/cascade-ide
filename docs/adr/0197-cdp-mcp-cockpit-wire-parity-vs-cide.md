...
| surface | Surface mounts | **real-ish** gate/match/presenter/alias/meta+presentMode/world+editor+fallbackSnap + SoftOrgans | Pane loop thin; Present() by mode; Handle still peel |
