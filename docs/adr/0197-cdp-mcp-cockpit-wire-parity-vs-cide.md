...
| surface | Surface mounts | **real-ish** gate/match/presenter/alias/meta+presentMode/pin+layout catalogs/world+editor+fallbackSnap + SoftOrgans | Pane loop thin; Present() by mode; pin/layout CCU; Handle still peel |
