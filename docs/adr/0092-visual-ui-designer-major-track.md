...
**Дата:** 2026-04-24  
**Связь:** [0022](0022-mfd-visual-design-surface-axaml-blazor.md) — **норматив по продукту** (MFD, WinForms-подобный цикл, Blazor+AXAML как один слой «design surface», не-цели v1). Этот ADR **не** переписывает 0022: фиксирует **организацию работ** и **приоритет стеков** как **отдельный крупный трек**, чтобы не сливать бэклог с ядром редактора, агентского контура и отладки.
