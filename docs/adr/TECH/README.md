...
| **Профили запуска** (несколько стартовых конфигураций, MCP, миграция с `startup-project.json`); опц. **MFD browser** для того же URL | [0090](../0090-launch-profiles-and-debug-startup-configurations.md) · [0093](../0093-mfd-embedded-browser-for-launch-url.md) (Proposed) |
