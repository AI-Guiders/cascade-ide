...
- По умолчанию — **компактная карточка** (сворачиваемая), не полноэкранный wizard; визуальный ориентир — мокап в [docs/ui-ux/concept-screens/cascade-ide-checklist-ui-concept.png](../ui-ux/concept-screens/cascade-ide-checklist-ui-concept.png).
