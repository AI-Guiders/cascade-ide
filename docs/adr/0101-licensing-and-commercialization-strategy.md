...
0. **Код CascadeIDE в этом репозитории** распространяется под **MIT** (см. корневой [`LICENSE`](../LICENSE)); коммерческие услуги и публичные контакты — в [`COMMERCIAL-NOTICE.md`](../COMMERCIAL-NOTICE.md).
