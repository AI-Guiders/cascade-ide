...
0. **Код CascadeIDE в этом репозитории** распространяется под **MIT** / MIT (see ethical-use policy) (см. корневой [`LICENSE`](../LICENSE) и политику в [`README.md`](../README.md)); коммерческие услуги и публичные контакты — в [`COMMERCIAL-NOTICE.md`](../COMMERCIAL-NOTICE.md).
