...
| 0031, 0045, 0048, 0082, 0087, 0165, 0166, **0175**, **0176**, **0177**, **0178**, **0179**, **0180**, **0181**, **0182**, **0183**, **0184**, **0185**, **0186**, **0187**, **0188**, **0189**, **0190**, **0195** | [чат](0031-agent-chat-clarification-batches-and-threading.md) · [persistence](0045-agent-chat-persistence-event-log-and-projections.md) · [Cursor parity](0048-cursor-acp-chat-ide-parity-and-mcp-tool-surface.md) · [loopback MCP](0082-acp-ide-mcp-loopback-single-process.md) · [MAF](0087-microsoft-agent-framework-builtin-agent-orchestration.md) · [**MCP transport stratification**](0165-mcp-transport-stratification-stdio-http-and-host-matrix.md) · [**agent-centric harness**](0166-agent-centric-harness-model-comfort-and-pay-per-token-economics.md) · [**ADCM Partition continuity**](0175-adcm-partition-continuity-pair-and-message-anchors.md) · [**FS relocate / affordances**](0176-agent-fs-relocate-and-harness-affordances.md) · [**harness MCP presence**](0177-harness-mcp-presence-signal.md) · [**agent SCM scene**](0178-agent-scm-scene-detect-map-act.md) · [**MCP progress ≠ unblock**](0179-mcp-progress-mid-op-not-agent-unblock.md) · [**agent shell habitat**](0180-agent-shell-habitat-tabs-scene.md) · [**MCP ImageContent vision opt-in**](0181-mcp-imagecontent-agent-vision-opt-in.md) · [**Restore Previous desk**](0182-restore-previous-desk-dual-instance.md) · [**Cockpit Intercom continuity**](0183-cockpit-intercom-chat-continuity.md) · [**Harness channel mute**](0184-harness-channel-mute-earplugs-cockpit.md) · [**Life thread self-wake**](0185-life-thread-delayed-self-wake.md) · [**Anchor families**](0186-anchor-families-navigation.md) · [**CDP mcp_scene outlet**](0187-cdp-mcp-scene-agent-outlet.md) · [**Agent internet browser (lynx)**](0188-agent-internet-browser-lynx-scene.md) · [**Cockpit tiles**](0189-cockpit-tile-manager.md) · [**Agent IDE Settings**](0190-agent-ide-settings-organ.md) · [**Voice input PTT/VAD ear**](0195-voice-input-ptt-vad-harness-ear.md) |
...
| [0003](0003-debug-ui-mode-separate-from-power.md) | Отдельный UI-режим Debug (не кокпит Power) | Accepted |
| [0004](0004-ui-thread-marshaling.md) | Маршалинг обновлений UI через `IUiScheduler` | Accepted |
...
| [0007](0007-signals-coupling-and-ui-backpressure.md) | Сигналы, связность, нагрузка на UI | Accepted |
...
| [0010](0010-ui-modes-toml-configuration.md) | Данные UI-режимов в TOML | Accepted |
| [0011](0011-debug-situational-awareness.md) | Ситуационная осведомлённость в отладке (полоска, hover; детали в панели) | Accepted |
| [0012](0012-floating-workspace-chrome.md) | Плавающий и отцепляемый хром workspace (телеметрия, полоски; не доки в v1) | Accepted |
| [0013](0013-command-surface-and-discoverability.md) | Поверхность команд и discoverability (палитра, минимальный toolbar) | Accepted |
| [0014](0014-situational-checklists.md) | Ситуационные чеклисты (модель, триггеры, UI; родитель — 0013) | Accepted |
...
| [0030](0030-command-ids-hotkeys-and-ui-registry-layers.md) | Слои `command_id`, хоткеев и UI: IdeCommands, палитра, TOML, мост VM; чертёж единого каталога | Accepted |
...
| [0038](0038-agent-facade-ai-provider-and-tool-orchestration.md) | Фасад агента: `AiProviderManager`, чат vs ACP vs автономный JSON-цикл; внешние MCP; идеи оркестрации и tool-calling | Accepted |
| [0039](0039-workspace-navigation-affordances.md) | Навигация по workspace; C# / .NET north-star (не polyglot v1); граф/semantic map; PFD/MFD; MCP: пресеты, `kind_filter`, subgraph | Accepted |
| [0040](0040-lsp-launch-line-settings-toml-presets-and-environment.md) | LSP C#/Markdown: командная строка в `settings.toml`, пресеты, опциональные ключи; env — открыто в ADR | Accepted |
...
| [0052](0052-agent-contract-cli-and-snapshot-tests.md) | CLI для контракта агента (паритет с MCP) и снапшот-тесты | Accepted |
| [0053](0053-semantic-map-control-flow-pfd.md) | Карта намерений и поток управления на PFD (control flow, KISS, subgraph) | Accepted |
...
| [0056](0056-semantic-map-pipeline-adoption.md) | Карта намерений: внедрение общего Skia pipeline (композитор, controlFlow layout, cursor semantics) | Accepted |
...
| [0072](0072-chat-topic-cards-intent-melody-keyboard-contract.md) | **Чат:** topic cards, drill-in/back, adaptive default; intent-based Melody/Chords v1 для навигации по темам; уточняет [0060](0060-keyboard-chord-stack-fms-tactical-strategic.md) в chat-domain | Accepted |
...
| [0099](0099-ide-databus-typed-events-and-projections.md) | **IDE DataBus:** типизированные события в процессе IDE; развязка источников и проекций, без подмены 0094 (transport) и 0097 (CCU) | Accepted |
...
| [0103](0103-editor-hud-substrate-semantic-projection-and-surface-adapter.md) | **Субстрат Editor HUD:** `SemanticProjectionPipeline` / `EditorHudEngine` / `IEditorSurfaceAdapter`; DAL / CCU / DataBus; отдельный hi-freq bounded-контур; baseline AvaloniaEdit; сравнение хостов в `design/`, roadmap UI в `ui-ux/` | Accepted |
| [0105](0105-hybrid-codebase-index-for-csharp-web.md) | Hybrid codebase index: переносимое ядро + MCP для C#/Razor/AXAML (Roslyn истина для C#); гибрид FTS+vec | Accepted |
...
| [0107](0107-blank-solution-creation-via-dotnet-new-sln.md) | Пустое решение: `dotnet new sln`, меню/MCP, `BlankSolutionCreator` + `IDotnetCommandRunner` | Accepted |
| [0108](0108-web-ai-portal-host-object-tools-bridge.md) | Веб-портал для внешних веб-ИИ: WebView, Host Object → `IdeCommands`/MCP; allowlist, согласие; PoC (Atlas / Search AI) | Accepted |
...
| [0111](0111-editor-linenumber-linerange-value-objects.md) | Редактор: `LineNumber` / `LineRange` (1-based, Start ≤ End); `ParsedLineRange`; граница к JSON — `int` в args команд | Accepted |
| [0112](0112-command-palette-query-modes-strategy.md) | Палитра (Ctrl+Q): режимы строки, стратегии и контракт бэкенда workspace-поиска (`t:`/`m:`/`x:`) с переключением в settings | Accepted |
...
| [0117 (SkiaKit)](0117-ide-skia-kit.md) | **SkiaKit:** переиспользуемые Skia-примитивы IDE (sectioned cards, tile grid) | Accepted |
...
| [0175](0175-adcm-partition-continuity-pair-and-message-anchors.md) | **ADCM Partition:** TopicDecisions + Handover ops + export/message anchors; continuity между окнами | Proposed |
...
| [0187](0187-cdp-mcp-scene-agent-outlet.md) | **CDP mcp_scene:** agent mounts other MCPs (`cdp_mcp`) | Accepted · Implemented |
| [0188](0188-agent-internet-browser-lynx-scene.md) | **Agent internet browser:** `scene_internet_browser` (lynx in CDP) | Accepted · Implemented |
| [0189](0189-cockpit-tile-manager.md) | **Cockpit tile manager:** pins/layout → parallel panes | Accepted · Implemented |
| [0190](0190-agent-ide-settings-organ.md) | **Agent IDE Tools→Options:** `cdp_settings` pages + hot prefs | Accepted · Implemented |
| [0191](0191-scan-pattern-seats-desk-repl.md) | **Scan Pattern seats + desk REPL:** P\|F\|M + `cmd=` | Accepted |
| [0192](0192-agent-task-manager-plan-mode.md) | **Agent task manager / plan mode** | Accepted |
