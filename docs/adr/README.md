...
| [0113](0113-hci-semantic-map-orientation-layer.md) | HCI × Semantic Map: слой **ориентации** (FTS/vec, hit_kind, UI-строка); не граф и не Roslyn; связка с `SemanticMapInputSnapshot` / CCU | Proposed |
