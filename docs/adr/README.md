...
| [0080](0080-intercomm-naming-and-multi-party-channel-model.md) | **Intercomm:** продуктовое имя канала связи вместо узкого «чат»; агент + команда + системные реплики; discoverability/i18n; strangler для кода | Proposed |
