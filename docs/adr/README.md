...
| [0039](0039-workspace-navigation-affordances.md) | Навигация по workspace: не только дерево; граф/semantic map, PFD vs MFD для «шкафа»; связь с PFD и 0037 | Proposed |
