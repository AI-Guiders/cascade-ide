...
| [0105](0105-hybrid-codebase-index-for-csharp-web.md) | Hybrid codebase index (**канон см. MCP-репо** `hybrid-codebase-index`; здесь только отсылка) | Accepted · Implemented |
