...
| [0034](0034-pilot-incapacitation-emergency-mode-and-presence-sensing.md) | Incapacitation оператора, Emergency Mode (стабилизация репозитория/автономности); опционально webcam как присутствие; программные триггеры — база | Proposed |
