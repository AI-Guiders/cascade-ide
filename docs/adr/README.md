...
| [0047](0047-cockpit-widget-descriptor-and-slot-composition.md) | Виджет кабины (`Widget`): дескриптор композитора слота (`CockpitWidgetDescriptor`), не `Control`; SE vs Semantic Map как примеры | Proposed |
