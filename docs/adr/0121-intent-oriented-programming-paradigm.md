...
- Принять **Intent-Oriented Programming (IOP)** — *интенционально-ориентированное программирование* — как **именованную парадигму продукта** Cascade IDE (**рабочая реализация гипотезы в продукте**), а не как замену ООП/ФП в кодовой базе.
...
IOP в CIDE — **дисциплина информационного контура** в agent-first IDE. **C#, проекты и редактор остаются source of truth** для текста программы ([0084](0084-agent-edits-editor-source-of-truth-presence-channel.md), [0098](0098-semantic-first-document-as-projection.md)).
