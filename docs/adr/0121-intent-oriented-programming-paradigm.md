...
3. **Слабый контекст агента:** без канона KB и маршрутизации (`route_context`, playbook'и) интенты «плывут»; нужна явная модель **эпистемических ограничений**, а не только промпт.
