...
- **Intercom** в перспективе — **центр коммуникации вокруг цели** (люди + агенты → намерение → реализация), см. [0120](0120-primary-work-surface-intercom-or-editor.md), [0080](0080-intercom-naming-and-multi-party-channel-model.md).
- **Командная среда** — несколько кокпитов + **общий ситуационный экран** (не лента чата), см. [0122](0122-collaborative-iop-environment-and-shared-situational-display.md).
...
|-------|----------|-------------|
| Намерение | Implemented (v1) | Melody, палитра, MCP; [0119](0119-chat-slash-commands-intercom-surface.md) фазы A–B; [0120](0120-primary-work-surface-intercom-or-editor.md) |
...
| 2026-05-17 | Ссылка на [0122](0122-collaborative-iop-environment-and-shared-situational-display.md) — среда vs приложение. |
