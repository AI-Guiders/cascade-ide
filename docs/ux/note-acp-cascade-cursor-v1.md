...
**Статус:** рабочая заметка (терминология и ссылки; не дублирует ADR). **Архитектурное решение** по встроенному чату и Cursor CLI — **[ADR 0016](../adr/0016-agent-client-protocol-external-agent.md)**. Детали протокола — в [официальной спецификации](https://agentclientprotocol.com/).
