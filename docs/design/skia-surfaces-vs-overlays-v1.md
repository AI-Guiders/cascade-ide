...
| **Вторичный контур** | `MfdShellView`: переключаемые **страницы** `SecondaryShellPage` (чат, терминал, сборка, обозреватель решения, …). Зона внимания **Mfd** — якорь презентации; **страница** — не то же самое, что зона ([0021](../adr/0021-pfd-mfd-cockpit-attention-model.md)). |
