...
Правило **не специфично для CIDE**: project-aware вход в IOP/KB (папка + диалог vs готовый контур) — в **[IOP-манифесте](../iop-manifest-v1.md#два-порога-входа-project-aware)**. Здесь — только **пример** для Cascade IDE: онбординг дизайнера — [handbook §1.1](cide-design-handbook-v1.md#11-два-порога-входа-cide); не демонстрировать скептику сразу handbook и D1–D9 без точки «папка + один вопрос».
