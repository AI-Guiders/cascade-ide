...
## 2. Почему в истории полезен ориентир «классический» Visual Studio
...
## 3. Класс риска: облачный ассистент как «плохой актёр»
...
## 4. Что закрепляет CascadeIDE (согласование с архитектурой)
...
## 5. Метафоры в одном направлении
...
## 6. Палитра vs аккорд, discoverability
