...
Правило **не специфично для CIDE**: вход «папка + диалог» vs готовый контур — в **[IOP-манифесте](../iop-manifest-v1.md#два-порога-входа-project-aware)**. Исторически: сначала разговор и любопытство, потом файл для записей агентом, потом KB и project-aware маркеры — **совместно** с агентом, не «контур сверху». Здесь — только CIDE: [handbook §1.1](cide-design-handbook-v1.md#11-два-порога-входа-cide).
