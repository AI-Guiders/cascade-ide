...
├── 0129-intercom-message-body-markdown-and-fenced-code.md   ← fenced / MD в теле
...
| **D4b** | **Тело: fenced / MD** | Fenced `` ``` `` в ленте; полный MD — preview [0069](../adr/0069-markdown-preview-tool-surface-and-renderer-decoupling.md) | [0129](../adr/0129-intercom-message-body-markdown-and-fenced-code.md) Proposed | [0123](../adr/0123-intercom-full-skia-surface-evolution.md), [0069](../adr/0069-markdown-preview-tool-surface-and-renderer-decoupling.md) | mono strip в ленте |
...
- Реализация фаз [0128](../adr/0128-intercom-attachment-anchors-and-code-references.md) (schema 0045, reveal overlay)  
- Fenced / MD в ленте — [0129](../adr/0129-intercom-message-body-markdown-and-fenced-code.md)  
- `@file` inline — отложено (0128)  
...
| 2026-05-19 | Ссылка на [ADR 0128](../adr/0128-intercom-attachment-anchors-and-code-references.md), [0129](../adr/0129-intercom-message-body-markdown-and-fenced-code.md). |
