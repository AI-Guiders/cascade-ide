...
!!! tip "Маршрут для дизайнера (без ADR)"
    0. **[IOP-манифест § Два порога](../iop-manifest-v1.md#два-порога-входа-project-aware)** — онбординг IOP/KB; **§1.1** — только как это выглядит в CIDE.  
...
Общее правило IOP/KB (папка, project-aware, любопытство vs интегрированный контур) — **[IOP-манифест](../iop-manifest-v1.md#два-порога-входа-project-aware)**. Ниже — только **как это ложится на дизайн Cascade IDE**:
