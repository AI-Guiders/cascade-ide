...
Открыть **Cursor**, поднять **MCP**, вести работу, **глядя в CascadeIDE вместо Visual Studio**, и **видеть действия агента** в том же контуре, что и своё: где стоят точки останова, где выполнение остановилось, где затык (сборка, тесты, ожидание, ошибка), без обязанности переключаться в VS «проверить правду».
