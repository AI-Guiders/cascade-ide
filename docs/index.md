...
!!! tip "IOP — Intent-Oriented Programming"
    CIDE — открытая **рабочая реализация** [интенционально-ориентированного программирования (IOP)](iop-manifest-v1.md): намерение → синтез агентом → верификация diff человеком.  
