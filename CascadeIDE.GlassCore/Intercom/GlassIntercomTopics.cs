...
/// <summary>
/// Virtual History topic cards — cluster journal stamps by quiet gap (default 30m).
/// Toolkit-agnostic; Glass WPF maps journal Entry → <see cref="Stamp"/>.
/// </summary>
public static class GlassIntercomTopics
{
    public static readonly TimeSpan DefaultGap = TimeSpan.FromMinutes(30);

    public sealed record Stamp(string Id, string Body, DateTimeOffset StampedUtc);
        ...
        TimeSpan? gap = null)
    {
        ...
        var bucket = new List<Stamp> { ordered[0] };
    ...
    static Topic Build(List<Stamp> bucket, int ordinal)
    {
