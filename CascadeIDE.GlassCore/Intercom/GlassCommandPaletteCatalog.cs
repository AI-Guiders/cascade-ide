...
public static class GlassCommandPaletteCatalog
{
    ...
    [
        ...
        new("topics_all", "Topics: Overview", "ADR 0072 topic catalog (c:atb)", "topics all overview atb"),
        new("topic_overview", "Topics: Overview", "Show topic card overview (c:atb)", "topic overview atb"),
        new("topic_enter", "Topics: Enter", "Open focused topic detail (c:ato)", "topic enter open ato"),
