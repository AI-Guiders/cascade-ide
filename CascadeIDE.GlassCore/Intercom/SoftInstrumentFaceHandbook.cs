...
/// <summary>Human SoftInstrument Face — situations → steps (ADR 0014), not markdown wall / not jargon chips.</summary>
public static class SoftInstrumentFaceHandbook
{
    ...
    public static bool IsSoftInstrumentGlancePage(string? page) =>
