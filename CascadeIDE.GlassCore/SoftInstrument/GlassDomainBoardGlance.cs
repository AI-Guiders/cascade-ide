...
/// <summary>
/// SoftInstrument domain ownership board — workspace <c>.cdp/domain/*.md</c> cards + habitat latch.
/// Human-faced instrument (not SoftInstrumentMfdGlance text dump; not inventory mill).
/// </summary>
